	...
	<div class="modal-overlay">
		<div id="info-modal" class="modal">
			...
			<ul class="test-card-list">
				<li>
					<img alt="Visa" src="./storefronts/shared/images/visa.svg" />
					<div>
				...
				<li>
					<img alt="Mastercard" src="./storefronts/shared/images/mc.svg" />
					<div>
				...
				<li>
					<img alt="Discover" src="./storefronts/shared/images/disc.svg" />
					<div>
				...
				<li>
					<img alt="American Express" src="./storefronts/shared/images/amex.svg" />
					<div>
